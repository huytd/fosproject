...
namespace GameEntities
{
    ...
    public class Inventory
    {
        ...
        public void RemoveItem(Vec2 location, EControl hud)
        {
            ...
            hud.Controls["Inventory/" + InventoryHelpers.Vector2BattleShip(location)].BackTexture = TextureManager.Instance.Load(@"Gui\HUD\BLOCK.tga", Texture.Type.Type2D, 0);
        }
        ...
        public Item GetItem(string battleshipPos)
        {
            Vec2 pos = InventoryHelpers.BattleShip2Vector(battleshipPos);
        ...
        public void OnRender(EControl hud)
        {
            foreach (DictionaryEntry dItem in this.inventory)
            {
                ...
                if (theOrigItem.Type.InventoryIcon == null)
                    theOrigItem.Type.InventoryIcon = @"Gui\HUD\GameMessageTitleBorder.png";
