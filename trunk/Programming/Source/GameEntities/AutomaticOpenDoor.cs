...
namespace GameEntities
{
	...
	public class AutomaticOpenDoor : Door
	{
		...
		void UpdateState()
		{
			...
			float distance = Type.AutomaticOpenDistance;
			Bounds bounds = new Bounds( Position - new Vec3( distance, distance, distance ),
				Position + new Vec3( distance, distance, distance ) );
