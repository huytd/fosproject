...
namespace GameEntities
{
	...
	/// </summary>
	/// <remarks>
	/// See <a href="EntitySystem_PlayerControl.htm">Entity System: Player Control</a> to find out more.
	/// </remarks>
	public sealed class GameControlsManager
	{
		...
		/// <summary>
		/// Gets an instance of the <see cref="GameEntities.GameControlsManager"/>.
		/// </summary>
