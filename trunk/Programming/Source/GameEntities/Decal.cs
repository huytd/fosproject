...
namespace GameEntities
{
	...
	public class Decal : MapObject
	{
		...
		void CreateDecal()
		{
			...
			staticMeshObject = SceneManager.Instance.CreateStaticMeshObject(
				bounds + Position, Position, Quat.Identity, new Vec3( 1, 1, 1 ),
				material, vertexData, indexData, true );
			...
			Camera camera, ref bool allowRender )
		{
			if( needMaterialAlpha != 1 )
			{
				if( shaderBaseMaterial != null )
				{
					...
					ColorValue diffuse = shaderBaseMaterial.DiffuseScale;
